  ...
  return (
    <section className="projects mx-auto py-10">
      ...
      <div className="flex flex-col mt-10">
        ...
        <img src={Portrait} alt="portrait" width={500} height={250} className="project-img justify-self-center cool-border" />
        </div>
        <article className="flex-col text-center m-5">
          ...
          <p className="text-2xl mt-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore sit incidunt earum asasaas</p>
        </article>
      </div>
      <div className="flex flex-col mt-10 md:flex-row">
        <div className="flex-col text-center m-10">
          <p className="text-3xl mt-10">Lorem ipsum</p>
          <p className="text-xl mt-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore sit incidunt earum asasaas</p>
        </div>
